...
<!-- 
	Author: liqs
	Name:  meetingError.jsp
	Description: 部门重复提交相同会议申请时显示的信息
-->
<html>
<head>
<title></title>
...
<table Width="870" Height="77%" Border="0" Cellpadding="0" Cellspacing="0" Bgcolor="#ffffff" Style="table-layout: Fixed">
  <tr> 
    <td Valign="top" >
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<p align="center">&nbsp; <font color="#FF0000">提示：</font>&nbsp;  
<font color="#FF0000">领导在此时间段正参与其他会议，请检查！</font><font size="2">&nbsp;</font><a href="javascript:history.go(-1)"><font color="#000000">返回</font></a></p>
</table>
<center>
