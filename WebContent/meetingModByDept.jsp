...
<%
 ...
 String[] myMeeting = (String[])request.getAttribute("result");  //会议列表
...
<!-- 
	Author: liqs/houyy
	Name:  meetingModByDept.jsp	
	Description: 会议申请部门对未处理或被拒批的会议申请修改
-->
...
<table Width="870" Height="77%" Border="0" Cellpadding="0" Cellspacing="0" Bgcolor="#ffffff" Style="table-layout: Fixed">
 ...
 <form name="timeForm" action="" method="post">                
  <p align="center"><b><font color="#000000" size="2">会 议 申 请 修 改</font></b></p>                                                                        
  ...
  <input type="reset" value="重写" name="B2" style="font-size: 8pt"></p>                         
   ...
   <input type="hidden" name="ctrl" value="deptModified">         
