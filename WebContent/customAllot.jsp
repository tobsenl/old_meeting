...
<!-- 
	Author: houyy
	Name:  customAllot.jsp
	Description: 例会会议室重分配
-->
<script>                        
function allot(){  
	var flag = 0;				
	...
	allotForm.ctrl.value = "CustomModSubmit";
...
<FORM name ="allotForm" METHOD=POST action="">
        ...
        <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="698cc3">
          <tr> 
            <td>
<table width="700"  border="0" cellpadding="1" cellspacing="1">
 ...
 <%
	 for(int i=0;i<allRoom.length;i++){ 
       ...
       remark = allRoom[i][4]; 
       if(unavailableRoom.containsValue(roomId.trim()))   
       disable = "disabled";
       else
       disable = "";
 ...
 %>
     <tr bordercolor="gray" bordercolordark="white" bgcolor="#FFFFFF" class="P1"> 
		<TD width="10%" valign="middle" align="center"><input type="radio" value="<%=roomId%>"  name="radio"  <%=disable%>></TD>
...
<% } %>
    <tr bgcolor="#FFFFFF"> 
		<TD align="center" colspan="5" width="490">
          <p align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#000000">&nbsp;   
          <input type="button" value="提交" name="" onclick= "allot()">&nbsp;    
