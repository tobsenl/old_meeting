...
<!-- 
	Author: 
	Name:  historyCustomVisit.jsp
	Description: 浏览历史例会记录
-->
<%  //会议记录信息
    String Id = "";	
    String week = ""; 
...
function modCheck(){
    ...
    visitForm.ctrl.value="toHistoryCustomMod";
...
function delCheck(){  
	...
	if (i==0) {
	  ...
	  return false;
        ...
        visitForm.ctrl.value="historyCustomDel";
        visitForm.action = "MeetingServlet"; 
        visitForm.submit();
	    }
	}
...
<form name="visitForm" method="post" action="">
         <p align="center" class="tabletitle"><font size="2"><b>历史例会浏览</b></font></p>
...
<table width="837"  border="0" cellpadding="1" cellspacing="1">
  <tr bordercolor="gray" bordercolordark="white" bgcolor="#FFFFFF" class="P1"> 
		<TD width="118" align="center">日期</TD>
		<TD width="104" align="center">会议名称</TD>
		<TD width="67" align="center">
          主持人</TD>
		<TD width="104" align="center">
          <p align="center">公司领导</TD>
		<TD width="126" align="center">参加单位/人员</TD>
		<TD width="89" align="center">有关说明</TD>
		<TD width="101" align="center">会议地点</TD>
		<TD width="90" align="center">申请部门/日期</TD>
		<TD width="36" align="center">选中</TD>
	</tr>
<%
 ...
 %> 
  <tr bordercolor="gray" bordercolordark="white" bgcolor="#FFFFFF" class="P1"> 
		...
		<TD width="104"><%=(content ==null || content.equals("null"))?"":content%></TD>
		<TD width="67"><%=(presider ==null || presider.equals("null"))?"":presider%></TD>
		<TD width="104"><%=(leader ==null || leader.equals("null"))?"":leader%></TD>
		<TD width="126"><%=(depart ==null || depart.equals("null"))?"":depart%></TD>
		<TD width="89"><%=(remark ==null || remark.equals("null"))?"":remark%></TD>
		<TD width="101"><%=(building ==null || building.equals("null"))?"":building%>
		<%=(room ==null || room.equals("null"))?"":room%>(<%=(capacity ==null || capacity.equals("null"))?"":capacity%>人)</TD>
		<TD width="90"><%=(applyDept ==null || applyDept.equals("null"))?"":applyDept%><BR>
		<%=(commitTime ==null || commitTime.equals("null"))?"":commitTime%></TD>
		<TD width="36" valign="middle" align="center"><input type="checkbox" name="checkbox" value="<%=Id%>"></TD>
  </tr>
<%}%>

    <tr bgcolor="#FFFFFF"> 
	  <TD colspan="9" align="center" width="793">
		   <font color="#000000"> 
				 <INPUT style="color: #000000; background-color: #FFFFFF" type="button" name="mod" value="修改" onclick="modCheck()">&nbsp;&nbsp; 
                 <INPUT style="color: #000000; background-color: #FFFFFF" type="button" name="delete" value="删除" onclick="delCheck()"> 
