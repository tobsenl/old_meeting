...
<table Width="870" Height="77%" Border="0" Cellpadding="0" Cellspacing="0" Bgcolor="#ffffff" Style="table-layout: Fixed">
 ...
 <form name="timeForm" action="" method="post">                
   <p align="center" class="tabletitle"><font size="2"><b>例会模板添加</b></font></p>
  ...
  <input type="button" value="提交" name="B1" style="font-size: 8pt" onclick="check('RegularMeetingTemplateServlet?ctrl=saveAdd')">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;          
